...
public class DataHolder {
    ...
    private final Condition bufferNoflagty = aLock.newCondition();
...
//                bufferNoflagty.signalAll(); // ann
                bufferNoflagty.await();
            }
